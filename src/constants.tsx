...
export const SKILLS = [
  {
    ...
    skills: [
      ...
      {
        name: "HTML5",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/html-5.png",
      },
      {
        name: "CSS3",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/css.png",
      },
      {
        name: "SASS",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/sass.png",
      },
      {
        name: "SQL",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/postgres.png",
      },
    ],
  },
  {
    ...
    skills: [
      ...
      {
        name: "NextJS",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/nextjs.png",
      },
      {
        name: "Redux",
      ...
      {
        name: "Tailwind CSS",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/tailwind-css.png",
      },
      {
        name: "Framer Motion",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/framer-motion.png",
      },
      {
        name: "D3 JS",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/d3-js.png",
      },
      {
        name: "Storybook",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/storybook.png",
      },
      {
        name: "React Router",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/react-router.png",
      },
    ],
  },
  {
    ...
    skills: [
      ...
      {
        name: "GraphQL",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/graphql.png",
      },
      {
        name: "Jest",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/jest.png",
      },
      {
        name: "Vitest",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/vitest.png",
      },
    ],
  },
  {
    ...
    skills: [
      ...
      {
        name: "AWS - Lambda",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/aws-lambda.png",
      },
      {
        name: "AWS - EC2",
      ...
      {
        name: "CI CD",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/ci-cd.png",
      },
      {
        name: "Docker",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/docker.png",
      },
      {
        name: "Kubernetes",
        url: "https://res.cloudinary.com/dz7vrcmfw/image/upload/v1738142436/profile/skills/kubernetes.png",
      },
    ],
  },
];
